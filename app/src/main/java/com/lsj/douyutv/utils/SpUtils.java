...
public class SpUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "douyutv_sp_data";
     ...
     */
    public static Object get(@NonNull String key, @NonNull Object defaultObject) {
     ...
     * @param imageView
     */
    public static void putImage(@NonNull String key, @NonNull ImageView imageView) {
     ...
     * @param imageView
     */
    public static Bitmap getImage(@NonNull String key, @NonNull ImageView imageView) {
